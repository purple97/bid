...
var _default = () => {
  ...
  let babelOptions = {
    ...
    plugins: [[require('babel-plugin-react-scoped-css'), {
    ...
    require('@babel/plugin-proposal-class-properties'), require('@babel/plugin-proposal-object-rest-spread'), require('babel-plugin-add-module-exports'), [require('@babel/plugin-transform-runtime'), {
      helpers: false,
      regenerator: true
